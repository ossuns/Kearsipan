      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="http://localhost/sistemlplpo/obat/" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>List Obat</p>
                </a>
              </li>
...
<!-- AdminLTE -->
<script src="<?php echo base_url('assets/vendor/dist')?>/js/adminlte.js"></script>

<!-- OPTIONAL SCRIPTS -->
<script src="<?php echo base_url('assets/vendor/plugins')?>/chart.js/Chart.min.js"></script>
<script src="<?php echo base_url('assets/vendor/dist')?>/js/demo.js"></script>
<script src="<?php echo base_url('assets/vendor/dist')?>/js/pages/dashboard3.js"></script>
</body>
</html>
