...
<body class="hold-transition login-page" background-image:url="assets/images/gambar.jpg">

<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Sistem Informasi</b><br>Laporan Pemakaian dan Lembar Permintaan Obat (LPLPO)</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url()."login/"; ?>" method="post">
        <div class="form-group has-feedback">
          <span class="fa fa-envelope form-control-feedback"> Username</span>
