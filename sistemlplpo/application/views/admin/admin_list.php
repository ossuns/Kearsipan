    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('admin/read/'.$admin->username),'Read'); 
				echo ' | '; 
				echo anchor(site_url('admin/update/'.$admin->username),'Update'); 
				echo ' | '; 
				echo anchor(site_url('admin/delete/'.$admin->username),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
