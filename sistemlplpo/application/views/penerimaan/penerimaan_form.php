...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Penerimaan <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="int">Jumlah Penerimaan <?php echo form_error('jumlah_penerimaan') ?></label>
            <input type="text" class="form-control" name="jumlah_penerimaan" id="jumlah_penerimaan" placeholder="Jumlah Penerimaan" value="<?php echo $jumlah_penerimaan; ?>" />
        </div>
	    <input type="hidden" name="id_penerimaan" value="<?php echo $id_penerimaan; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('penerimaan') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>